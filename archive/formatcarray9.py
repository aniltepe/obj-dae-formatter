...
new_file = open(script_dir + "/obj/male.obj", "w+")
lines = []

for vertice in vertices:
    new_line = "v " + str(vertice.position.x) + " " + str(vertice.position.y) + " " + str(vertice.position.z) + "\n"
    lines.append(new_line)

for triangle in triangles:
    new_line = "f " + str(triangle.child_indexes[0] + 1) + " " + str(triangle.child_indexes[1] + 1) + " " + str(triangle.child_indexes[2] + 1) + "\n"
    lines.append(new_line)
